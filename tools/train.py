...
#  python tools/train.py --data ./faces --img-size 256 --patch 16 --epochs 200 --bs 256 --workers 4 --lr 3e-4 --ema --amp bf16 --compile --save-dir checkpoints --name tinyvitdet_faces --export-onnx checkpoints/tinyvitdet_faces.onnx